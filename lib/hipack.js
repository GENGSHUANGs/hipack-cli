...
global._hipack_npm_command = process.platform === 'win32' ? 'npm.cmd' : 'npm';
...
commander
    .option('start [dir] [--verbose] [--force] [--install]', 'start the develope server ')
    .option('build [dir] [--release]', 'build the resource')
    .option('--force','force rebuild runtime')
